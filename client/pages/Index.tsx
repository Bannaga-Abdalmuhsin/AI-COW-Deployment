...
export default function Index() {
  return <div className="min-h-screen bg-[#f7f4f8] text-[#25102f]">
    ...
    <main>
      ...
      <section className="mx-auto max-w-[1500px] px-6 pb-20 lg:px-10"><div className="grid gap-6 rounded-3xl border border-[#e6dce9] bg-white p-8 shadow-sm lg:grid-cols-[1fr_1fr] lg:p-10"><div><div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-700"><ShieldCheck /></div><h2 className="mt-5 text-3xl font-bold">Built for responsible operational use</h2><p className="mt-4 max-w-xl text-sm leading-7 text-slate-500">The demonstration excludes raw movement history, coordinates, routes, and the full record-level forecast set. A limited upcoming prediction queue is provided for planning review.</p></div><div className="grid gap-3 sm:grid-cols-2"><Control text="Protected application routes"/><Control text="Sanitized aggregate dataset"/><Control text="Chronological model validation"/><Control text="Private backend integration ready"/></div></div></section>
    </main>
